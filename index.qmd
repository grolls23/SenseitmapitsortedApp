...
-   The data is used to develop an indicative flood risk map for regions and sub-regions in Pakistan.

-   Risk is a function of hazard, exposure and vulnerability as defined by UNDRR.

-   The baseline assumption is that areas that have been flooded in the past are at higher risk of flooding in the future.

-   A cumulative analysis of flood events between 2000 and 2018. Counting the flood occurance is used as a proxy for eposure.

-   Vulnerability is the product of the raw population count and the number of flood occurrences
