...
Our projects involves 3 key parts using different data: population, land-use, and vulnerability.
...
The vulnerability index is a product of the population count and number of flood occurrences per area, calculated as below:

``` js
var vulnerabilityIndex = clippedHRSL.multiply(clippedCumulativeFlooded);
```

For prettier visualisation, the vulnerability index is smoothed using a 500m kernel, using the function below.
