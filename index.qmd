...
Our project is split into 3 main parts that use different data sources: population, land-use, and vulnerability. The `app.js` file collects the different data layers and parts of analysis into one integrated application, which is deployed into a live Google Earth Engine Application. Each elemnt is described in detail below:
